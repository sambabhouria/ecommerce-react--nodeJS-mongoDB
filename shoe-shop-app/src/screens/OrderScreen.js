...
import { ORDER_PAY_RESET } from "../Redux/Constatns/OrderConstants";

const OrderScreen = ({match}) => {
  window.scrollTo(0, 0);

  const [sdkReady, setSdkRready] = useState(false);
  ...
  // console.log("🚀 ~ file: OrderScreen.js ~ line 27 ~ OrderScreen ~ orderPay", orderPay)
  ...
  // PAYMENT RESULT AND DISPATCH ACTION
